...
<div class="w-full h-full flex flex-col items-center justify-center px-20">
    <div class="text-[32px] font-bold text-[#333333] py-8">팝업 등록</div>

    <form action="./process/popup_input_process.php" method="POST" enctype="multipart/form-data" class="w-full">
        <div class="w-full h-24 flex items-center">
            ...
            <input type="text" name="popup_Title" class="w-[50%]" required>
        </div>
        <div class="w-full h-60 flex items-center">
            <div class="w-[20%] h-full flex justify-center items-center bg-gray-200 mr-4 border-b-2 border-white">
                링크 주소
            </div>
            <textarea name="popup_Link" class="w-[75%] h-[90%]" placeholder="http:// 포함, 링크없을시 공백" ></textarea>
        </div>

        <div class="w-full h-full flex items-center border-b-2 border-white">
            <div class="w-[20%] h-[300px] flex justify-center items-center bg-gray-200 mr-4">팝업 이미지</div>
            <div class="w-[50%] flex items-center gap-4 justify-between">
                <!-- 미리 보여질 이미지 태그 -->
                <div>
                    <input type="file" name="popup_Img" class="w-[100%]">
        ...
        <div class="w-full h-24 flex items-center">
            ...
            <div class="flex items-center justify-center">
                ...
                <input type="date" name="popupStart_Date" class="px-2" required>

                <div class="pl-8 pr-2">종료일</div>
                <input type="date" name="popupEnd_Date" class="px-2" required>
            </div>
        </div>
        <div class="w-full h-24 flex items-center">
            <div class="w-[20%] h-full flex justify-center items-center bg-gray-200 mr-4 border-b-2 border-white">메인페이지 표시</div>
            <div class="flex items-center">
                <input id="checkbox" type="checkbox" checked name="popup_Show" class="mr-2">
...
<script>
    ...
    function previewImage() {
        ...
        const fileInput = document.querySelector('input[name="popup_Img"]'); // 이미지 파일 input 태그
