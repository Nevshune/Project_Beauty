          ...
          "spaceBetween": 30
            ...
            <?php while ($row = $result->fetch_assoc()) : ?>
                <swiper-slide class="flex justify-center items-center">
                    <div class="w-full flex-col gap-8 max-[1150px]:flex-col justify-center items-center">
                        <div class="w-full aspect-w-16 aspect-h-9 flex justify-center items-center rounded-md overflow-hidden">
                            <img class="object-cover w-full" src="./Admin/uploads/class/<?php echo $row['classThumbnail']; ?>" alt="">
                        </div>
                        <div class="flex-col">
