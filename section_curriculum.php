        ...
        <div class="w-full py-20 max-[767.5px]:py-10 px-4 max-md:px-8">
            ...
            <a href="https://www.hrd.go.kr/hrdp/ti/ptiao/PTIAO0300L.do" target="_blank" class="w-full">
                <div class="flex gap-0 space-x-0 relative min-h-32 mt-8 mb-8">
                    ...
                    translate-x-[-50%] translate-y-[-50%] text-[#333333] font-bold shadow-[4px_4px_10px_1px_rgba(0,0,0,0.25)]">
                        <!-- <img src="./src/logo/header_logo.png" alt="" class="max-w-40"> -->
                        <div class=" flex items-center text-4xl max-[650px]:text-3xl pl-2 gap-3">
                            <span>신청하러 가기</span> 
                            <!-- <i class="fa-solid fa-arrow-pointer"></i> -->
                             <span>
                                <img class="w-[80%]" src="./src/img/finger.png" alt="">
                             </span>
                        </div>
                    </div>
