<section class="w-full flex flex-col justify-center items-center  py-24 bg-[#eeeeee]" id="curriculum">
    <div class="w-full max-w-[1280px] flex flex-col justify-center px-4 items-center space-y-8">
        ...
        <div class="flex flex-col text-xl justify-center items-center text-[#7F00AC] font-AppleSDGothicNeo">
            <p><span class="max-md:block text-center">얼굴 및 신체의 피부를 아릅답게</span> <span class="max-md:block text-center">유지 · 보호 · 개선 관리하기 위하여</span></p>
            <p><span class="max-md:block text-center">각 부위와 유형에 적절한 관리법과</span> <span class="max-md:block text-center">기기 및 제품을 사용하여 피부미용을 수행</span></p>
        </div>
    </div>
